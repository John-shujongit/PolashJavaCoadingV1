...
public class OopDemoWithHash {
	...
	public static HashMap<String, String> data() {
		...
		hh.put("one", "pa@gmail.com@p123@abc");  //HashMap no Gurentee, aerssending order or inserted order
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver",path+"\\ex\\chromedriver.exe");
